...
public class AddGroupMemberAdapter extends RecyclerView.Adapter<AddGroupMemberAdapter.UserExportContactsViewHolder> {
    ...
    public AddGroupMemberAdapter(Context context, List<UserConnectionsData> userConnectionsData) {
        ...
        UserExportContactsViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    EventBus.getDefault().post(new EventBusAddGroupMember(getAdapterPosition(), exportContactsFilteredList.get(getAdapterPosition()).getUser_id(), exportContactsFilteredList.get(getAdapterPosition()).getProfile_id()));
                }
            });
        }
    }
