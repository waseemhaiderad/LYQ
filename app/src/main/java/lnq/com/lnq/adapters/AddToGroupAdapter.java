...
public class AddToGroupAdapter extends RecyclerView.Adapter<AddToGroupAdapter.UserExportContactsViewHolder> {
    ...
    public AddToGroupAdapter(Context context, List<CreateUserGroup> userConnectionsData) {
    ...
    public UserExportContactsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.cus_addto_group_dialog, parent, false);
    ...
    public void onBindViewHolder(@NonNull UserExportContactsViewHolder holder, int position) {
        CreateUserGroup userConnectionsData = exportContactsFilteredList.get(position);
        String groupName = userConnectionsData.getGroup_name();
    ...
    class UserExportContactsViewHolder extends RecyclerView.ViewHolder {
        ...
        UserExportContactsViewHolder(View itemView) {
            ...
            FontUtils.getFontUtils(context).setTextViewSemiBold(textViewGroupName);
