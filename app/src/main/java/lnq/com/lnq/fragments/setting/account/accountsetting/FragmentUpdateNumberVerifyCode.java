...
public class FragmentUpdateNumberVerifyCode extends Fragment {

    //    Android fields....
    private FragmentUpdateNumberVerifyCodeBinding binding;
    private VerifyCodeClick clickHandler;

    public FragmentUpdateNumberVerifyCode() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_update_number_verify_code, container, false);
