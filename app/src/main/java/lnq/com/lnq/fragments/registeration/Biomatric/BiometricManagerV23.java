...
public class BiometricManagerV23 {
    ...
    public void displayBiometricPromptV23(final BiometricCallbackPrint biometricCallback) {
        generateKey();
            ...
            fingerprintManagerCompat.authenticate(cryptoObject, 0, mCancellationSignalV23,
                    new FingerprintManagerCompat.AuthenticationCallback() {
                        ...
                        public void onAuthenticationFailed() {
                            ...
                            updateStatus(context.getString(com.an.biometric.R.string.biometric_failed));
...
//            displayBiometricDialog(biometricCallback);
    ...
    private void displayBiometricDialog(final BiometricCallbackPrint biometricCallback) {
